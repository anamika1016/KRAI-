Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      get "user-dashboard/boxes", to: "user_dashboard#boxes"
      ...
      get "user-dashboard/lists/:list_type/export", to: "user_dashboard#export"
      get "admin-dashboard", to: "jeevika_jankar_dashboard#show"
      get "admin-dashboard/filters", to: "jeevika_jankar_dashboard#filters"
      get "admin-dashboard/widgets/:widget", to: "jeevika_jankar_dashboard#widget"
