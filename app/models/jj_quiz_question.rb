class JjQuizQuestion < ApplicationRecord
  ...
  def self.template_rows
    [
      ["What is the main objective of organic farming?", "Increase chemical use", "Improve soil health and safe production", "Only packaging", "None", "B"],
      ["What can be used as training attendance proof?", "Photo", "Farmer list", "Both A and B", "None", "C"]
    ]
  end
